<?php
	class ISC_ADMIN_ORDERS extends ISC_ADMIN_BASE
	{
		...
		public function authorizingAction(){
            require_once(ISC_BASE_PATH.'/modules/checkout/yijiesppay/module.yijiesppay.php');
            $yijipayClass = GetClass('CHECKOUT_YIJIESPPAY');
            $result = $yijipayClass->authorizingAction($_GET['orderId'],$_GET['resolveReason'],$_GET['isAccept']);
