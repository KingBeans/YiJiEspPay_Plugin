...
class ControllerModuleEspay extends Controller {
    private $error = array();

    public function index() {
        # load language file
        // $this->load->language('payment/espay');
        $this->load->language('module/espay');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            # add extension payment espay

            $this->load->model('module/espay');
            $this->model_module_espay->addPayment('payment', 'espay');
            // $this->load->model('');
        ...
        $data['espay_notify'] = 'http://' . $_SERVER['SERVER_NAME'] . '/catalog/controller/module/espay_receive.php';
...
// var_dump($this->request->post);
        ...
        $data['action'] = $this->url->link('module/espay', 'token=' . $this->session->data['token'], 'SSL');
...
// var_dump($data['action']);
    ...
    protected function validate() {
        # check permission
        if (!$this->user->hasPermission('modify', 'module/espay')) {
