            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group required">
                            <label class="col-sm-2 control-label"
                                   for="espay-secret-key"><?php echo $entry_secret_key; ?></label>

                            <div class="col-sm-10">
                                <input type="text" name="espay_secret_key" value="<?php echo $espay_secret_key; ?>"
                                       placeholder="<?php echo $entry_secret_key; ?>" id="espay-secret-key"
                                       class="form-control"/>
