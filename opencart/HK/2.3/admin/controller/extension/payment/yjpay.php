...
class ControllerExtensionPaymentYjpay extends Controller
{
    ...
    public function index(){
        ...
        $data['action'] = $this->url->link('extension/payment/yjpay', 'token=' . $this->session->data['token'], true);
        ...
        $data['breadcrumbs'] = array(
            ...
            array(
                ...
                'href' => $this->url->link('extension/payment/yjpay', 'token=' . $this->session->data['token'], 'SSL')
            )
        );

        $this->response->setOutput($this->load->view('extension/payment/yjpay.tpl', $data));
    }
