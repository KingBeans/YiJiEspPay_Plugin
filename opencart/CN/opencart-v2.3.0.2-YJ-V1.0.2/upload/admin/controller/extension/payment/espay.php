...
class ControllerExtensionPaymentEspay extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['espay_secret_key'])) {
            $data['espay_secret_key'] = $this->request->post['espay_secret_key'];
        } elseif ($this->config->get('espay_secret_key')) {
            $data['espay_secret_key'] = $this->config->get('espay_secret_key');
        } else {
            $data['espay_secret_key'] = '';
        }
    ...
    public function order() {
        ...
        if ($espay['status'] == ModelExtensionPaymentEspay::STATUS_NEW ||
            ...
            $api = new ESPayApi(
                ...
                $this->config->get('espay_secret_key'),
            ...
            if ($result) {
                if ($result->orderStatus == 'PAY_SUCCESS' ) {
                    $this->model_extension_payment_espay->payed($orderID, $result->tradeTime);
                    ...
                    $this->model_extension_payment_espay->payedFail($orderID, $result->tradeTime);
                    $this->model_extension_payment_espay->addOrderHistory($orderID,
                    ...
                    $this->model_extension_payment_espay->authorizing($orderID, $result->tradeTime);
                    $this->model_extension_payment_espay->addOrderHistory($orderID,
    ...
    protected function validate() {
        ...
        if (!$this->request->post['espay_secret_key']) {
            $this->error['error_secret_key'] = $this->language->get('error_secret_key_empty');
        }
