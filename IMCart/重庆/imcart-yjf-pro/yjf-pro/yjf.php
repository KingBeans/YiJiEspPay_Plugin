...
require_once('lib/OrderCore.php');
...

	{
...

		{
			...
			Common::redirect('http://' . REDIRECT_DOMAIN . '/h-order-step2.html?itemno=' . $itemno );
...
$data = array (
		...
		//公共参数
		  ...
		  'notifyUrl'	=> 'http://' . $notifySite .'/yjf-pro/yjf_notify.php',

		  'returnUrl'	=> 'http://' . $notifySite . '/yjf-pro/yjf_return.php',
...
$orderDetail = array (
	...
	'logisticsMode' 	=> $shipping_method,	//物流方式
	...
	// 'customerPhonenumber' => '0124347980',	//购买者电话
...
$data['goodsInfoList']	 = json_encode($goodsList);
