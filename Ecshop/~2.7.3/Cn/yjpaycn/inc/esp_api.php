...
class esp_api
{
    ...
    const SERVICE_PRESALE_RESULT         = 'espOrderJudgment';
    const SERVICE_ORDER_REFUND           = 'espRefund';
    const SERVICE_ORDER_PAY              = 'espOrderPay';
    ...
    function order_pay($order, $goods, $notify_url, $return_url = '')
    {
        ...
        $submit['orderDetail']    = json_encode($orderDetails,true);
        ...
        $submit['goodsInfoList']  = json_encode($goods,true);
        // 公共参数
        ...
        $submit['deviceFingerprintId'] = 'rand_id'.mt_rand(1000000,9999999);
    ...
    function order_cancel($order_sn, $reason = '')
    {
        $submit = array(
            ...
            'returnUrl'    => $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/yjpaycn_return.php',
            'notifyUrl'    => $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/yjpaycn_receive.php',
    ...
    function process_confirm($order_sn,$reason)
    {
        $submit = array(
            ...
            'returnUrl'    => $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/yjpaycn_return.php',
            'notifyUrl'    => $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/yjpaycn_receive.php',
            // 'notify_url'    => 'http://hk.ecshop273.com/yjpaycn_receive.php',
            'originalMerchOrderNo'  => $order_sn,
            'resolveReason'         => $reason,
            'merchOrderNo'  => $order_sn . time(),
            'isAccept'      => 'true'
