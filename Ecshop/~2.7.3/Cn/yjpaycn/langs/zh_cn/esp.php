...
$_LANG['yjpaycn'] 		= '易极付';
$_LANG['yjpaycn_desc'] 	= '易极付(https://www.yiji.com/) 是国内先进跨境的网上支付平台。';
$_LANG['yjpaycn_submit'] 	= '使用易极付支付';


$_LANG['yjpaycn_cfg_merchant_name'] 	= '商家名称';
$_LANG['yjpaycn_cfg_merchant_email'] 	= '商家邮箱';
$_LANG['yjpaycn_cfg_partner_id'] 		= '合作商家号';
$_LANG['yjpaycn_cfg_secret_key'] 		= '商家安全码';

$_LANG['yjpaycn_cfg_debug']		= '调试模式?';
$_LANG['yjpaycn_cfg_debug_range'] = array(0 => '否','1' => '是');

$_LANG['yjpaycn_cfg_currency'] = '结算货币';
...
$_LANG['yjpaycn_wait_notify'] = <<<EOF
	提交支付，正在等待完成.<script type="text/javascript" src="yjpaycn.php?order_sn=%s"></script>
EOF;

$_LANG['yjpaycn_pay_success'] = <<<EOF
	支付成功: <a href="yjpaycn.php?order_sn=%s&act=refund">申请退款</a>
EOF;
...
$_LANG['yjpaycn_wait_authorize'] = <<<EOF
	当前支付存在风险，需要预付权(%s): <a href="yjpaycn.php?order_sn=%s&act=authorize">授权</a>
EOF;
