...
$_LANG['yjpay'] 		= 'YJF';
$_LANG['yjpay_desc'] 	= 'Yijifu Techology CO,LTD is a company that offers international credit card payment service , certifatied by QSP(Visa) .';
$_LANG['yjpay_submit'] 	= 'Use YJF for payment';


$_LANG['yjpay_cfg_merchant_name'] 	= 'Merchant_name';//
$_LANG['yjpay_cfg_merchant_email'] 	= 'Merchant email';//
$_LANG['yjpay_cfg_partner_id'] 		= 'Partner id';//
$_LANG['yjpay_cfg_secret_key'] 		= 'Security code';//

$_LANG['yjpay_cfg_debug']		= 'Debug mode';//
$_LANG['yjpay_cfg_debug_range'] = array(0 => 'No','1' => 'Yes');//No Yes

$_LANG['yjpay_cfg_currency'] = 'Currency';// 
...
// aquiring type
$_LANG['yjpay_cfg_payment_type'] = 'Payment Type';// 
$_LANG['yjpay_cfg_payment_type_range'] = array(
    'CRDIT'  => 'Credit Card',//
    'YANDEX' => 'E-Bank',
);
...
$_LANG['yjpay_pay_ret_title'] = <<<EOF
    Your order has been received
EOF;

$_LANG['yjpay_wait_notify'] = <<<EOF
	Payment has been submitted,please wait.<script type="text/javascript" src="yjpay.php?order_sn=%s"></script>
EOF;

$_LANG['yjpay_pay_success'] = <<<EOF
	Payment success: <a href="yjpay.php?order_sn=%s&act=refund">Refund</a>
EOF;

$_LANG['user_yjpay_success_title'] = <<<EOF
...
$_LANG['yjpay_wait_authorize'] = <<<EOF
	This payment contains some risks ,authorization needed.(%s): <a href="yjpay.php?order_sn=%s&act=authorize">authorization</a>
EOF;
