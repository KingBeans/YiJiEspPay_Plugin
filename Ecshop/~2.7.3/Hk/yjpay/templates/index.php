...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="yjpay/templates/css/style.css"/>
</head>
<body>
<div class="container">
	<br/>
    <div class="report">
        <div class="row">
            ...
            <div class="col-6">
				...
				<?php echo sprintf('%s %.2f',$payment['yjpay_cfg_currency'],$order['order_amount']); ?>
				</h2>
            </div>
    ...
    <?php } ?>
    <div class="body">
        <form class="cform" method="POST" action="yjpay.php?order_sn=<?php echo $order['order_sn']; ?>&act=submit">
            <fieldset>
                <legend>
                ...
                <div class="form-group">
                    ...
                    <div class="form-control col-4">
                        <select id="card_country" name="card[country]">
                            ...
                            <?php foreach ($_LANG['yjpay_countries'] as $code => $country) {
...
<script type="text/javascript" src="/yjpay/templates/js/jquery.min.js"></script>
