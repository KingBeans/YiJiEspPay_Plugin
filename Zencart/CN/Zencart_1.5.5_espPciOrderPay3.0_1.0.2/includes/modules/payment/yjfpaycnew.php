...
class yjfpaycnew extends base {
    ...
    function  confirmation() {
        $confirmation = [
            'fields' => [
                [
                    'title' => MODULE_PAYMENT_YJFPAY_TEXT_CREDIT_CARD_NUMBER,
                    'field' => zen_output_string_protected($_POST['yjfpay_cardNo']),
                ],
                [
                    'title' => MODULE_PAYMENT_YJFPAY_TEXT_CREDIT_CARD_EXPIRES,
                    'field' => strftime('%B, %Y', mktime(0, 0, 0, $_POST[ 'yjfpay_expires_month'], 1, '20' . $_POST[ 'yjfpay_expires_year'])),
                ],
            ],
        ];
    ...
    function process_button() {
        ...
        $process_button_string .= zen_draw_hidden_field('yjfpay_cardNo', zen_output_string_protected($_POST['yjfpay_cardNo']));
        $process_button_string .= zen_draw_hidden_field('yjfpay_cvv', preg_replace('/[^0-9]/', '', $_POST['yjfpay_cvv']));
        $process_button_string .= zen_draw_hidden_field('yjfpay_expires_year', preg_replace('/[^0-9]/', '', (int)$_POST['yjfpay_expires_year']));
        $process_button_string .= zen_draw_hidden_field('yjfpay_expires_month', preg_replace('/[^0-9]/', '', $_POST['yjfpay_expires_month']));
