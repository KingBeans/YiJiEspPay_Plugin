<?php
    ...
    function do_pay_success($db, $orderHistory) {
        ...
        zen_db_perform(TABLE_ORDERS_STATUS_HISTORY, $statusHistory);
        zen_db_perform(TABLE_ORDERS, $orderUpdate, 'update', 'orders_id = ' . $order_id);
        zen_db_perform(TABLE_YJFPAYC_HISTORY, $historyUpdate, 'update', 'order_id = ' . $order_id);
    }
    ...
    function do_pay_authorizing($db, $orderHistory) {
        ...
        zen_db_perform(TABLE_ORDERS_STATUS_HISTORY, $statusHistory);
        zen_db_perform(TABLE_ORDERS, $orderUpdate, 'update', 'orders_id = ' . $orderID);
        zen_db_perform(TABLE_YJFPAYC_HISTORY, $historyUpdate, 'update', 'order_id = ' . $orderID);
