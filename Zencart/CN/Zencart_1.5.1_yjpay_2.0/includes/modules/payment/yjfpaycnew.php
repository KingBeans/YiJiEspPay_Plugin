<?php
    ...
    class yjfpaycnew extends base {
        ...
        function after_process() {
            ...
            zen_db_perform(TABLE_YJFPAYC_HISTORY, $order_history_array);
            zen_db_perform(TABLE_ORDERS, $order_update_array, 'update', 'orders_id = ' . $insert_id);
            ...
            if ($history->RecordCount() && !$history->EOF) {
                ...
                if ($result->success) {
                    ...
                    if (isset($_POST['cancel']) || $refundAmount == $history['pay_total']) {
                        ...
                        zen_db_perform(TABLE_ORDERS, $update_order_array, 'update', 'orders_id=' . $orderID);
                    ...
                    zen_db_perform(TABLE_YJFPAYC_HISTORY, $update_history_array, 'update', 'order_id=' . $orderID);
                    zen_db_perform(TABLE_ORDERS_STATUS_HISTORY, $order_status_history_array);
                }
