<?php
    ...
    define('MODULE_PAYMENT_YJFPAYCNEW_CONFIGURATION_SECRET_KEY_TITLE', ' Merchant secret key');
    define('MODULE_PAYMENT_YJFPAYCNEW_CONFIGURATION_SECRET_KEY_DESCRIPTION', ' merchant secret key from YJF');
