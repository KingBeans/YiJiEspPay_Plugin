<?php
    ...
    define('MODULE_PAYMENT_YJFPAYCNEW_TEXT_DESCRIPTION', '<div align="center"><img src=/includes/modules/pages/yjpay/images/logo_cq.png></div>');
    ...
    define('MODULE_PAYMENT_YJFPAYCNEW_CONFIGURATION_ORDER_PREFIX_TITLE', 'Order prefix');
    define('MODULE_PAYMENT_YJFPAYCNEW_CONFIGURATION_ORDER_PREFIX_DESCRIPTION', 'order prefix: the YJF order source distinction');
    ...
    define('TEXT_PLEASE_TRY_AGIAN','<strong>Order Result :</strong> ');
    define('TEXT_PLEASE_AUTHORIZING', '<strong>Authorized payment, please contact us to process authorization.</strong> ');
    define('TEXT_PLEASE_PROCESSING', '<strong>Please wait. No duplicate payment during payment processing.</strong> ');
    define('TEXT_PLEASE_SUCCESS', '<strong>Payment Successful, waiting for us to deal with.</strong> ');
