<?php
    ...
    define('MODULE_PAYMENT_YJFPAYCNEW_TEXT_DESCRIPTION_ADMIN', '<strong>YJF-CQ </strong>：make cross-boader payment by credit card <br/><img src=includes/modules/pages/yjpay/images/logo_cq.png>');
    ...
    define('MODULE_PAYMENT_YJFPAYCNEW_CONFIGURATION_SECRET_KEY_TITLE', ' Merchant file password');
    define('MODULE_PAYMENT_YJFPAYCNEW_CONFIGURATION_SECRET_KEY_DESCRIPTION', ' merchant file password from YJF');
    ...
    define('MODULE_PAYMENT_YJFPAYCNEW_STATUS_6', 'Pre authorized access');
    ...
    define('MODULE_PAYMENT_YJFPAY_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:');
