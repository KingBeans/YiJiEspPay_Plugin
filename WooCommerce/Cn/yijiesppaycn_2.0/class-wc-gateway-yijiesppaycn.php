        ...
        public function init_form_fields(){
            ...
            $this->form_fields = array(
                ...
                'signKey' => array(
                    ...
                    'type' => 'text',
                    'description' => __('Please enter the file Password',$this->id) ,
                    'css' => 'width:400px'
                ) ,
                'url' => array(
...
//                            $woocommerce->cart->empty_cart();
        ...
        public function generate_yijiesppaybycn_form( $order_id ){
            ...
            if($this->embedded == 'yes'){
                file_put_contents(dirname(__FILE__).'/logs/'.date('Ymd').'log.txt',"[NOTIFY_REQUEST_ORDER_BY_".$order_id."](重定向地址):\n".get_transient('yijiesppaybycn_next_url').'请求url:'.esc_url( get_transient('yijiesppaybycn_next_url'))."\n\n",FILE_APPEND);
